...
public class BeanTestCaseTest extends TestCase {
    ...
    static final class TestObject {
        ...
        public boolean equals(Object obj) {
            ...
            return Util.equals(str, other.str) &&
                bool == other.bool &&
                shrt == other.shrt &&
                lng == other.lng &&
                Float.floatToIntBits(flt) == Float.floatToIntBits(other.flt) &&
                Util.equals(co, other.co);
        }        
    }
